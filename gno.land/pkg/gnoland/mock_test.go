...
type mockVMKeeper struct {
	...
	queryFn                     func(sdk.Context, vm.QueryMsgEval) (string, error)
...
func (m *mockVMKeeper) QueryEval(ctx sdk.Context, msg vm.QueryMsgEval) (res string, err error) {
	if m.queryFn != nil {
		return m.queryFn(ctx, msg)
	}
